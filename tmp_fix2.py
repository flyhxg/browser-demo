...
# Simple replacement - remove the old code and add new inside step_callback
old_code = '''        # Emit live_url if cloud mode (cdp_url is now available after get_or_create_cdp_session)
...
new_code = '''        # Emit live_url if cloud mode - sent inside step_callback when cdp_url is actually available
...
if old_code in content:
    ...
    print("Could not find the old code. Check the file manually.")
